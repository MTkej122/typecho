...
<div class="row member">
	...
	<div class="card bg-gradient-danger card-img-holder text-white">
	  <div class="card-body">
		<img src="<?php echo stcdn($this->options->themeUrl); ?>/images/circle.svg" class="card-img-absolute" alt="circle-image">
		<h4 class="font-weight-normal">文章总计<i class="icon iconfont icon-wenjuan"></i></h4>
	...
	<div class="card bg-gradient-info card-img-holder text-white">
	  <div class="card-body">
		<img src="<?php echo stcdn($this->options->themeUrl); ?>/images/circle.svg" class="card-img-absolute" alt="circle-image">
		<h4 class="font-weight-normal">评论次数<i class="icon iconfont icon-pinglun"></i></h4>
	...
	<div class="card bg-gradient-success card-img-holder text-white">
	  <div class="card-body">
		<img src="<?php echo stcdn($this->options->themeUrl); ?>/images/circle.svg" class="card-img-absolute" alt="circle-image">
		<h4 class="font-weight-normal">访问总计<i class="icon iconfont icon-icon-test"></i></h4>
	...
	<div class="card bg-gradient-warning card-img-holder text-white">
	  <div class="card-body">
		<img src="<?php echo stcdn($this->options->themeUrl); ?>/images/circle.svg" class="card-img-absolute" alt="circle-image">
		<h4 class="font-weight-normal">注册天数<i class="icon iconfont icon-icon-test24"></i></h4>
    ...
    <li class="menu-item active"><p><i class="icon iconfont icon-paihangbang"></i> 我的文章</p></li> 
    <li class="menu-item"><p><i class="icon iconfont icon-paihangbang"></i> 个人资料</p></li> 
     <?php if($GLOBALS['lock']==0): ?> <li class="menu-item"><p><i class="icon iconfont icon-icon-test13"></i> 扩展设置</p></li><?php endif; ?>
    <li class="menu-item"><p><i class="icon iconfont icon-pinglun"></i> 我的评论</p></li>
    <?php if ($this->options->applic =='1'):?>
    <li class="menu-item"><p><i class="icon iconfont icon-tishi"></i> 申请认证</p></li> 
    <?php endif; ?>
    </ul> 
...
?>		
    ...
    <div class="meb_top active">
      ...
      <article class="post-list contt blockimg "> <div class="entry-container"><span class="laid_title_l"></span> <div class="block-image feaimg"> <a class="block-fea scrollLoading" data-url="<?php echo stcdnimg($this->fields->img); ?>" href="<?php $this->permalink(); ?>" title="<?php $this->title(); ?>" style="background-image:url('<?php echo stcdn($this->fields->img); ?>')"></a></div> <header class="entry-header"><span class="entry-title"><a href="<?php $this->permalink(); ?>"><?php $this->title(); ?></a></span></header> <div class="entry-summary ss"><p><?php $this->excerpt(80, '...');?></p></div></div>
                    <div class="d_meta">
                    <time datetime="'.$cont_time.'"><i class="icon iconfont icon-icon-test4"></i> <?php echo formatTime($this->created); ?></time>
                    <span class="separator">/</span>
                    <i class="icon iconfont icon-taolunqu"></i> <?php $this->commentsNum('0 评论', '1 条评论', '%d 条评论'); ?> 
                    <span class="separator">/</span>
                    <i class="icon iconfont icon-icon-test"></i>  <?php Postviews($this); ?> 阅读
                    <span class="separator">/</span>
                    <i class="icon iconfont icon-dianzan"></i> <?php zannum($this); ?> 赞
                    <span class="separator">/</span>
                    <i class="icon iconfont icon-qinghuiyuan"></i> 积分 <?php echo get_pid_v($this->cid); ?>
    ...
    <?php if(yonghuzu($myuid)!='普通会员'): ?> 
    
    <div class="col-lg-6 meb_cl"> <div class="form__group"> <label class="form__label">创作者积分</label> <input type="text" class="form__input" value="<?php echo get_points_v($myuid,null); ?>" readonly  unselectable="on"> </div> </div>   
    
    <?php endif; ?>
    
    <div class="col-lg-6 meb_cl"> <div class="form__group"> <label class="form__label">会员积分</label> <input type="text" class="form__input" value="<?php echo get_pointy($myuid,null); ?>" readonly  unselectable="on"> </div> </div>    
...
?>" <?php if($GLOBALS['lock']==1): ?> readonly  unselectable="on"<?php endif; ?>> <?php endif; ?>
    ...
    <div class="col-lg-12 meb_cl"> <div class="form__group"> <label class="form__label">个人签名</label><input type="text" class="form__input" name="getintros" value="'.reintro($myuid).'"> </div> </div> 
    <div class="col-lg-12 meb_cl"> <input name="do" type="hidden" value="getintro"><button class="form__btn" type="submit" id="getintro" name="getintro" value="更新签名"><span>确定</span></button></div>
	  </form>';

    if(isset($_POST['getintro'])){ 
    if($_POST["getintro"]=="更新签名"){
      $intros = $_POST["getintros"];
      getintro($myuid,$intros)
 ?>
    <script language="JavaScript">window.setTimeout("location=\'\'", 10);</script>
...
<div class="base-alert"> <span class="base-alert-txt">积极对作品评论进行回复、点赞及置顶等管理操作，可以提升互动数，进而提升积分等级哦</span>
</div>
...
<div class="meta">
<div class="meta-item">    
<i class="icon iconfont icon-taolunqu"></i><a href="<?php $AuthorComment->permalink() ?>"><?php $AuthorComment->title(); ?></a>
</div>
...
<?php endif; ?>
    ...
    <?php if ($this->options->applic =='1'):?>
    <div class="meb_top">
    <?php require_once("assets/apply_aut.php");?>
    </div>
    <?php endif; ?>
    <!--box3-->
