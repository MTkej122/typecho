...
<div class="row author-page">
    ...
    <div class="ner-content"><?php fopagemember(); ?></div>  
    <?php else: ?>       
    ...
    <a class="avatar" href="<?php $users->permalink(); ?>"><?php $email=$users->mail; $imgUrl = getGravatar($email);echo '<img src="'.$imgUrl.'" srcset="'.$imgUrl.'" height="60" width="60">'; ?></a>
    </div>
	<div class="ner-info">
	<p class="ner-info-title">
            <a href="<?php $users->permalink(); ?>" title="<?php $users->screenName(); ?>" target="_blank" class="title-content" z-st="user_content_card_1_user_name"><?php $users->screenName(); ?></a>
    </p>
	<div class="info-num">
            <div class="work">
