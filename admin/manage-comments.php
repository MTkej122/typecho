		...
		<div class="card">
			...
			<form method="post" name="manage_comments" class="operate-form">
				<div class="table-responsive">
					...
					?>">
						...
						<td valign="top">
							<div class="comment-avatar">
								<img src="<?php $email =$comments->mail;if($email){if(strpos($email,'@qq.com') !==false){$email=str_replace('@qq.com','',$email);echo '//q1.qlogo.cn/g?b=qq&nk='.$email.'&s=100';}
					...
					<?php else: ?>
					<tr>
						<td colspan="4"><h6 class="typecho-list-table-title"><em><?php _e('没有评论') ?></em></h6></td>
					</tr>
					<?php endif; ?>
					</tbody>
