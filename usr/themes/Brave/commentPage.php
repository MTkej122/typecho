...
?>
   ...
   <link rel="stylesheet" href="https://cdn.txykoke.cn/typecho/css/OwO.min.css">
    ...
    <div class="commentlist">
        <div class="comment" id="li-<?php $comments->theId();?>">
            <div id="<?php $comments->theId(); ?>">
                ...
                <?php ob_start();
                $pattern = "/^[0-9-]+(\.[0-9-]{5,6,7,8,9,10}+)*@[q-qQ-Q-]{2}+(\.[c-oC-O-]{3}+)$/";
                $result = preg_match($pattern,$x1);
                echo $result;
                $num = ob_get_contents();
                ob_end_clean(); ?> 
                   ...
                   <?php
                        $nu = rand(1,29);
                        $picpath = "http://cdn.txykoke.cn/typecho/head/".$nu.".jpg";
                    ?>
                <?php if (1 === (int)$num) : ?>
			...
			<?php else : ?>
				<div class="comment-avatar"><img alt="" src="<?php echo $picpath;?>" data-src="<?php echo $picpath;?>" class="avatar avatar-96 photo" height="96" width="96" style="display: inline;"></div>
				<?php endif; ?>
                <div class="comment-body">
                    <div class="comment_author">
                        ...
                        <em><?php $comments->date('Y-m-d H:i'); ?> &nbsp;&nbsp;<span style="font-weight:bold">IP属地：<?php $comments->location(); ?>  &nbsp;<?php $comments->useragent($agentConfig = null); ?></span></em>
                    </div>
...
<?php if ($this->allow('comment')) : ?>
    <div id="<?php $this->respondId(); ?>" class="respond list-content mx-auto mt-5">
        <div class="list-top">
            ...
            <form method="post" action="<?php $this->commentUrl() ?>" name="comment-form" id="comment-form" role="form"
                ...
                <div class="form-group">
                    <textarea rows="3" cols="50" name="text" id="textarea" class="OwO-textarea form-control" 
                              placeholder="<?php _e('写下对我们的祝福'); ?>"
                              required><?php $this->remember('text'); ?></textarea>
                                
                            
                </div>
                <div class="OwO form-group"></div> 
     ...
     <script src="https://cdn.txykoke.cn/typecho/js/OwO.min.js"></script>
    ...
    <script>
        var OwO_demo = new OwO({
            ...
            api: 'https://cdn.txykoke.cn/typecho/js/OwO.json',
            position: 'down',
            width: '100%',
            maxHeight: '200px'
        });
