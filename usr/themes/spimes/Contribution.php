...
if(!$this->user->hasLogin()){
    ...
    //echo '<script>alert("请登录后投稿");</script>
    echo "<script> showMessage('游客无权限投稿哦！',2000,true,'bounceInDown-hastrans','bounceOutDown-hastrans');</script>";
}
if(yonghuzu($this->user->uid)=='普通会员'){
    echo "<script> showMessage('你暂无权限投稿哦！',2000,true,'bounceInDown-hastrans','bounceOutDown-hastrans');</script>";
}
