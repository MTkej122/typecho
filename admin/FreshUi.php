<div class="container-scroller">
	...
	<nav class="navbar default-layout-navbar col-lg-12 col-12 p-0 fixed-top d-flex flex-row">
		<div class="text-center navbar-brand-wrapper d-flex align-items-center justify-content-center">
			<a class="navbar-brand brand-logo" href="index.php" target="_self">
			    <img src="img/logo.svg" alt="logo">
		    </a>
			<a class="navbar-brand brand-logo-mini" href="index.php">
			    <img src="img/logo-mini.svg" alt="logo" target="_self">
		    </a>
		</div>
		<div class="navbar-menu-wrapper d-flex align-items-stretch">
            ...
            <a class="nav-link dropdown-toggle" id="profileDropdown" href="#" target="_parent" data-toggle="dropdown" aria-expanded="false">

              <div class="nav-profile-img">

                <?php echo '<img src="' . $navatar . '" alt="' . $user->screenName . '" />'; ?>
		...
		<nav class="sidebar sidebar-offcanvas" id="sidebar">
			<ul class="nav">
				<li class="nav-item nav-profile">
					<a href="<?php $options->siteUrl(); ?>" class="nav-link" target="_parent">
